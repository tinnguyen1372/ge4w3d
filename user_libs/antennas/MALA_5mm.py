...
# Fixed versions - dimensions increased to match resolution grid
    box(x + 0.054, y + casesize[1] - 0.017, z + skidthickness,x + 0.056,  y + casesize[1] - 0.014,z + skidthickness + casesize[2] - casethickness, 'free_space', rotate90origin=rotate90origin)
    box(x + 0.054, y + 0.012, z + skidthickness,x + 0.056, y + 0.016, z + skidthickness + casesize[2] - casethickness, 'free_space', rotate90origin=rotate90origin)
